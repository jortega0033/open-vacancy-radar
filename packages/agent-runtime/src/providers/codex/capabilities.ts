...
/**
 * What this adapter implements for Codex. See the parser and adapter.ts for the
 ...
 * - thinking: `reasoning` items normalize to thinking.delta (parser.ts); present only when Codex's
