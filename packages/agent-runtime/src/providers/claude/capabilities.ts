...
/**
 * What this adapter implements for Claude Code. See the parser and adapter.ts for the
 ...
 * - thinking: `thinking` content blocks normalize to thinking.delta (parser.ts); present only when
 ...
 * This is a display and selection list only. `buildClaudeArgs` passes the supplied value
