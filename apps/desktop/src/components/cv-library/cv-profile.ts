 ...
 * comma, repeated spaces) are dropped so they never become an empty skill chip.
 */
 ...
 * is a success/warning distinction that uses the state colors in DESIGN-TOKENS.md.
 */
