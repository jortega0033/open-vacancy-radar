 ...
 * before detecting a provider, before touching the filesystem, before any network activity
 * (ADI-19, ported from upstream's issue #65 acceptance criteria: "Without
 * AGENT_DOCK_LIVE_PROVIDER_SMOKE=1, no provider/network work occurs.").
 */
