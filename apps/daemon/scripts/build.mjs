...
// understand TS (tsx, Vite, and Vitest) get live source with no separate build step. A plain
...
// dependency it imports into one plain-JS file that plain Node can run standalone. This is
